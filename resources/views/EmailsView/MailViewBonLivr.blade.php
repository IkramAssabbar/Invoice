...
<body>
    <p>{{ $data['body'] }}</p>
        ...
        <h3 style="font-weight: bold; text-align: center;">Nouveau Bon de Livraison de Maroc Generation Agency</h3>
<div style="border: 1px solid black; padding: 20px; max-width: 600px; margin: 0 auto;">

    <h3 style="font-weight: bold; text-align: center;">Bon de Livraison</h3>
    ...
    <div style="margin-top: 40px; font-size: 17px;">
        ...
        <table style="width: 100%; margin-top: -40px;">
            <tr>
                ...
                <td>
                    <b>Adresse:</b> {{ $facture->adresse }}<br>
                </td>
            </tr>
        </table>
