...
<body>
    <p>{{ $data['body'] }}</p>
        ...
        <h3 style="font-weight: bold; text-align: center;">Nouveau Facture Recurrente de Maroc Generation Agency</h3>
<div style="border: 1px solid black; padding: 20px; max-width: 600px; margin: 0 auto;">

    <h3 style="font-weight: bold; text-align: center;">Facture Recurrente</h3>
