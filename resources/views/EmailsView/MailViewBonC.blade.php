...
<body>
    <p>{{ $data['body'] }}</p>
        ...
        <h3 style="font-weight: bold; text-align: center;">Nouveau Bon de Commande de Maroc Generation Agency</h3>
<div style="border: 1px solid black; padding: 20px; max-width: 600px; margin: 0 auto;">

    <h3 style="font-weight: bold; text-align: center;">Bon de Commande</h3>
        ...
        <table style="width: 100%; margin-top: -40px;">
            <tr>
                <td style="width: 50%;">
                    ...
                    <b style="color: red;">Échéance:</b> {{ $facture->dateLivraison }}
                </td>
            </tr>
        </table>
