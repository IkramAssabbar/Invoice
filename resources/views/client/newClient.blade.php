...
<div class="header pb-8 pt-5 pt-lg-5 d-flex align-items-center;" >
    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            ...
            <h1 style="font-family: cursive; color:rgb(27, 140, 210);" >Créer votre client</h1>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <form method="POST" action="{{ route('client.store') }}">
                ...
                <div class="col-md-12 mb-3">
                    <label for="inputIF" style="font-size: 13px;">Identifiant fiscal</label>
                    <input type="text" id="newClientIF" name="if" class="form-control shadow">
                </div>
                <div class="col-md-12 mb-3">
                ...
                <div class="col-md-12 mb-3">
                    <label for="inputPrenom" style="font-size: 13px;">Prénom* </label>
                    <input type="text" id="newClientPreName" name="prenom" class="form-control shadow">
                </div>
                <div class="col-md-12 mb-3">
