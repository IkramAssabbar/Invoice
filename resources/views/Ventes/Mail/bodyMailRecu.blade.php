    ...
    <div class="col-xl-6">
        <div class="card bg-secondary shadow">
            ...
            <div class="card cards card-2 text-center">
                <div class="card-body">
                    <form action="{{route('sendMailReccure')}}" method="GET">
                        <div class="form-group row">
                          <?php $client = session('client'); ?>
                          <?php $factureR = session('factureR'); ?>
                            ...
                            <div class="col">
                              ...
                              <input type="hidden" class="form-control" id="" placeholder="" name="factureid" value="{{ $factureR->id }}">
