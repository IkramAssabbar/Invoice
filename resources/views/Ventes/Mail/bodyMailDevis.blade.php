    ...
    <div class="col-xl-6">
        <div class="card bg-secondary shadow">
            ...
            <div class="card cards card-2 text-center">
                <div class="card-body">
                    <form action="{{route('sendMailDevis')}}" method="GET">
                        <div class="form-group row">
                          <?php $client = session('client'); ?>
                          <?php $devis = session('devis'); ?>
                            ...
                            <div class="col">
                              ...
                              <input type="hidden" class="form-control" id="" placeholder="idfacture" name="devisid" value="{{$devis->id }}">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col">
                              <textarea type="text" class="form-control" id="" placeholder="message à inclure" name="body">Bonjour,Veuillez trouver ci-joint votre Devis de MGA</textarea>
                            </div>
                          </div>
