...
<div class="header pb-8 pt-5 pt-lg-5 d-flex align-items-center;" >
    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            ...
            <h1 style="font-family: cursive; color:rgb(27, 164, 210);" >Créer votre Bon de Commande </h1>
            ...
            <div class="col-xl-10 order-xl-0">
                <div class="card bg-secondary shadow">
                    <div class=" bg-blu" style="padding: 0rem 1.5rem">
                        <div class="row align-items-center">
                            <h3 class="mb-0" style="font-family: sans-serif; color: white">{{ __('Bon de Commande') }}</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body bg-white border-0">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('entrepriseBC.update', $entreprise->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <!-- Champs de saisie -->
                                                    <div class="row">
                        ...
                        <td><input type="hidden" id="LibelleService"  placeholder="Rmse" class="champ-ligne" style="width: 60px" ></td>
                            ...
                            <form action="{{ route('DATABC.update', $entreprise->id) }}" method="POST">
                                @csrf
                                @method('PUT')
