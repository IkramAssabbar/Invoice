...
<div class="header pb-8 pt-5 pt-lg-5 d-flex align-items-center;" >
    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            ...
            <h1 style="font-family: cursive; color:rgb(27, 164, 210);" >Créer votre Bon de Livraison </h1>
                        ...
                        <div class="card-body pt-0 pt-md-4">
                            ...
                            <div class="text-center">
                                <div class="row" style="position: fixed">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <button type="submit" class="btn btn-primary btn-block mb-3" style="background-color: rgb(27, 164, 210);" formaction="{{ route('bonLiv.telecharger') }}" formmethod="POST" id="btnTelecharger" disabled>
                    ...
                    <div class="col-xl-10 order-xl-0">
                        <div class="card bg-secondary shadow">
                            <div class=" bg-blu" style="padding: 0rem 1.5rem">
                                <div class="row align-items-center">
                                    <h3 class="mb-0" style="font-family: sans-serif; color: white">{{ __('Bon de Livraison') }}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card-body bg-white border-0">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden"  name="date" class="dateValuee" required>
                                    <input  type="hidden"  name="echeance" class="echeanceValuee" required>
                                    ...
                                    <input type="hidden" class="adresseValuee" name="adresseValue" >

                    <!-- cest cette partie a copier dans les autres -->
    ...
    <!-- edit client -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('entrepriseBL.update', $entreprise->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <!-- Champs de saisie -->
                                                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <b-form-textarea name="" id="textdate" cols="30" no-resize readonly data-bs-toggle="modal"
                                    ...
                                    <b style="color:rgb(27, 164, 210)">Bon de Livraison</b> <br>
                            ...
                            <div  class="col-md-6"> 
                                ...
                                <b-form-textarea  id="textdate" cols="30" no-resize readonly data-bs-toggle="modal"
                                data-bs-target="#myModalAdress" class="custom-textarea">
                                <b style="color:rgb(27, 164, 210);margin-left: 50px;"class="col-md-6 text-end">Adresse de Livraison</b> <br>
                                <div style="margin-left: 65px;">
                                 <span id="adresseValue" class=""  contenteditable="true"></span><br>
                                   
                                <!--    <b> Adresse: </b><span id="adresseValue" name="" class=""></span> <br>
                                    <div class="row">
                                        <div class="col">
                                            <b>    Ville: </b><span id="villeValue" name="" class=""></span>
                                        </div>
                                        <div class="col">
                                            <b>   CP: </b><span id="CPValue" name="" class=""></span>
                                        </div>
                                    </div> -->
                        ...
                        <div class="modal fade" id="myModalAdress" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 class="modal-title" id=""  style="font-family: cursive; color:rgb(27, 164, 210);">mettez vos Cordonnées à jour</h2>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                            ...
                                            <!-- Champs de saisie -->
                                                <div class="row">
                                                   ...
                                                   <textarea name="" id="Adresseinput" cols="30" rows="2"></textarea>
                                                </div>
                                                
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                                                    <button type="button" class="btn btn-primary" onclick="enregisterAdresse()">Enregistrer</button>
                                                </div>
                        ...
                        <td><input type="hidden" id="LibelleService"  placeholder="Rmse" class="champ-ligne" style="width: 60px" ></td>
                            ...
                            <form action="{{ route('DATABL.update', $entreprise->id) }}" method="POST">
                                @csrf
                                @method('PUT')
