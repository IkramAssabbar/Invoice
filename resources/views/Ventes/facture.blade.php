                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card-profile-stats d-flex flex-column justify-content-center align-items-stretch mt-md-5" style="position: fixed;">
                                    <button type="submit" class="btn btn-primary  btn-block mb-3" style="background-color: rgb(27, 164, 210);"  id="btnEnvoyer" disabled>
                                        <i class="fas fa-paper-plane"></i> Envoyer</button>
                                    <button type="submit" class="btn btn-primary btn-block mb-3" style="background-color: rgb(27, 164, 210);" formaction="{{ route('facture.telecharger') }}" formmethod="POST" id="btnTelecharger" disabled>
                ...
                success: function(response) {
                    ...
                    var clientInfo = '<div class="client-info" style="margin-left:37px;">' +
                        ...
                        '<b>CP: ' + response.cp + '</p> <br>' +
                            '<input type="hidden" name="user_id" id="user_id" onchange="verifierChamps()" value="' + response.id + '">' +
