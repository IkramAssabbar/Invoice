...
<div class="header pb-8 pt-5 pt-lg-5 d-flex align-items-center;" >
    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            ...
            <h1 style="font-family: cursive; color:rgb(27, 164, 210);" >Créer votre facture Récurrente </h1>
 ...
 <div class="container-fluid mt--8">
     <form action="{{route('FacturesRecurentes.store')}}" method="post">
        @csrf 
         <div class="row">
                        ...
                        <div class="row" style="position: fixed">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select name="" id="" class="form-control">
                                    <option value="">Le premier jour de la période</option>
                                    <option value="">Le dernier jour de la période</option>
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-9 order-xl-0">
                ...
                <div class="card-body bg-white border-0">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('entrepriseR.update', $entreprise->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <!-- Champs de saisie -->
                                                    <div class="row">
                        ...
                        <td><input type="hidden" id="LibelleService"  placeholder="Rmse" class="champ-ligne" style="width: 60px" ></td>
                            ...
                            <form action="{{ route('DATAR.update', $entreprise->id) }}" method="POST">
                                @csrf
                                @method('PUT')
