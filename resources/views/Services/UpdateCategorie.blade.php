                                ...
                                <div class="container">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-8 mb-3 mb-lg-0">
                                                <input type="text" class="form-control " placeholder="Nom de la Categorie" id="categoriename"  style="padding-right:30px;" name="Nom_Categorie" value="{{$categorie->Nom_Categorie}}">
                                            </div>
                                        </div>
