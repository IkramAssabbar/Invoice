    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            <div class="col-md-12 {{ $class ?? '' }}">
                <h1 style="font-family: cursive; color:rgb(27, 164, 210);">Ajoutez votre Categorie</h1>
            </div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-xl-9 col-lg-8 col-md-12 col-12">
         <form method="POST" action="{{route('categorie.store2')}}">
            @csrf
                                ...
                                <div class="container">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-8 mb-3 mb-lg-0">
                                                <input type="text" class="form-control " placeholder="Nom de la Categorie" id="categoriename"  style="padding-right:30px;" name="categorieName">
                                            </div>
                                        </div>
