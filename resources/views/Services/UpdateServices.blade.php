    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            <div class="col-md-12 {{ $class ?? '' }}">
                <h1 style="font-family: cursive; color:rgb(27, 164, 210);">Modifier vos Services</h1>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="mb-2">
                        <div role="tabpanel" id="react-aria-99-tabpane-design" aria-labelledby="react-aria-99-tab-design" class="fade pb-4 p-4 tab-pane active show">
                            <div class="card mx-auto border border-dark" style="width: 500px;">
                                <div class="card-header mb-4" style="background-color: rgb(27, 164, 210);"><b>Services</b></div>
                                <div class="container">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-8 mb-3 mb-lg-0">
                                                <input type="text" class="form-control input-black-text" placeholder="Libelle" id="libelle"  style="padding-right:30px;" name="Libelle" value="{{$service->Libelle}}" >
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="Categorie" class="col-sm-4 col-form-label form-label" style="padding-left:30px;">Categorie</label>
                                            <div class="col-sm-8 mb-3 mb-lg-0">
                                                <select id="categoriedrop" class="mb-3" name="IdCategorie">
                                                    <option selected disabled>Select categorie</option>
                                                    @foreach ($categories as $categorie)
                                                        <option value="{{ $categorie->id }}" @if ($categorie->id == $service->IdCategorie) selected @endif>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-8 mb-3 mb-lg-0">
                                                <input type="text" class="form-control input-black-text" placeholder="Prix d'estimation" id="Prix" name="Prix"  style="padding-right:30px;" value="{{$service->Prix}}">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="Description" class="col-sm-4 col-form-label form-label" style="padding-left:30px;">Description</label>
                                            <div class="col-sm-8 mb-3 mb-lg-0">
                                                <input type="text" class="form-control input-black-text " placeholder="Description" id="Description" name="Description" style="padding-right:30px;" value="{{$service->Description}}">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="" class="col-sm-4 col-form-label form-label" style="padding-left:30px;">Tva</label>
                                            <div class="col-sm-8 mb-3 mb-lg-0">
                                                <input type="text" class="form-control input-black-text" placeholder="Tva" id="" name="Tva" style="padding-right:30px;" value="{{$service->Tva}}">
                                            </div>
                                        </div>
        ...
        <form method="POST" action="{{route('categorie.store')}}">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8 mb-3 mb-lg-0">
                        <input type="text" class="form-control " placeholder="Nom de la Catégorie" id="Prix" name="categorieName"  style="padding-right:30px;">
                    </div>
                </div>
