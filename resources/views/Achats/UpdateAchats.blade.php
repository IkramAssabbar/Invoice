    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            <div class="col-md-12 {{ $class ?? '' }}">
                <h1 style="font-family: cursive; color:rgb(27, 164, 210);">Modifier vos achats</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-xl-9 col-lg-8 col-md-12 col-12">
         <form method="POST" action="{{route('achats.update',$achat->id)}}">
            @csrf
            @method('put')
                                ...
                                <div class="container">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-8 mb-3 mb-lg-0">
                                                <input type="text" class="form-control " placeholder="Libelle" value="{{$achat->libelle}}"  style="padding-right:30px;" name="libelle">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="Categorie" class="col-sm-4 col-form-label form-label" style="padding-left:30px;">Categorie</label>
                                            <div class="col-sm-8 mb-3 mb-lg-0">
                                                <select id="categoriedrop" class="mb-3" name="categorieid">
                                                    <option selected disabled>Select categorie</option>
                                                    
                                                    @foreach ($categories as $categorie)
                                                        <option value="{{ $categorie->id }}" @if ($categorie->id == $achat->categorieid) selected @endif>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-8 mb-3 mb-lg-0">
                                                <input type="text" class="form-control " placeholder="Prix d'estimation" value="{{$achat->prix}}" name="prix"  style="padding-right:30px;">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="Description" class="col-sm-4 col-form-label form-label" style="padding-left:30px;">Description</label>
                                            <div class="col-sm-8 mb-3 mb-lg-0">
                                                <input type="text" class="form-control " placeholder="Description" value="{{$achat->description}}" name="description" style="padding-right:30px;">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="" class="col-sm-4 col-form-label form-label" style="padding-left:30px;">Tva</label>
                                            <div class="col-sm-8 mb-3 mb-lg-0">
                                                <input type="text" class="form-control " placeholder="Tva" value="{{$achat->tva}}" name="tva" style="padding-right:30px;">
                                            </div>
                                        </div>
